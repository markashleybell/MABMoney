...
namespace MABMoney.Tests
{
    ...
    public class UserControllerTests
    {
        ...
        public void SetUp()
        {
            ...
            _sessionServices = MockRepository.GenerateStub<ISessionServices>();
        }    

        [Test]
        public void Index_Get()
        {
            var controller = new UsersController(_userServices, _accountServices, _categoryServices, _transactionServices, _budgetServices, _context, _config, _dateProvider, _crypto, _urlHelper, _cache, _cachingHelpers, _sessionServices);
